/** Quan hệ giữa các bảng — dùng cho truy vấn lồng của Drizzle. */
import { relations } from "drizzle-orm/relations";
import { tenants, branches, users, roles, departments, employees, positions, tenantSettings, files, outboxEvents, auditLog, userBranchRoles, tenantFeatures } from "./index";
