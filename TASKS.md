...
| ID | Việc | Agent | Status | Owner | Tiêu chí nghiệm thu |
|---|---|---|---|---|---|
| T-10 | Schema danh mục: categories, brands, products (4 `kind`), variants, package_items, service_materials | Claude | DOING | Claude 05/09 | Migrate sạch; ràng buộc `kind` đúng; seed dữ liệu mẫu |
