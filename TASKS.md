...
| T-20 | Cron sao lưu: `pg_dump` → nén → Google Drive `/backups`, giữ 30 bản + ping chống pause | Claude | REVIEW | Claude 05/09 — chờ anh Khôi thêm GitHub secrets | Chạy 3 ngày liên tiếp có 3 file; khôi phục thử thành công |
